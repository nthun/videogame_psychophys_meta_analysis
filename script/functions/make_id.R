...
#        id_hierarchy: a data frame with identifier<chr>, and rank<num> columns that define the rank (importance) of an identifier. Smaller number means more important
