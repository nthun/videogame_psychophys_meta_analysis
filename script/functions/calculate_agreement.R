...
name_pairs %>% 
    mutate(kr_alpha = c(.52, .79, .82, .66, .56, .89),
           include_both = c(23, 32, 15, 26, 33, 22),
           exclude_both = c(122, 111, 203, 63, 95, 99),
           no_agreement = c(50, 43, 19, 53, 32, 11),
           invalid_decision = c(11, 5, 12, 10, 0, 0)) %>% 
    select(-name_df)
